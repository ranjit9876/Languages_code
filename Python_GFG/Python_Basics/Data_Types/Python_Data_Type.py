...
# frozenset_numbers = frozenset({1, 2, 2, 3, 5, 1})
# print(frozenset_numbers) # frozenset({1, 2, 3, 5})
...
# # Ellipsis Type
# ellipsis_data = ...
# print(f'ellipsis_data = {ellipsis_data}') # ellipsis_data = Ellipsis

# # Complex Type
# complex_number = complex(2, 3)
# print(f'complex_number = {complex_number}') # complex_number = (2+3j)

# # Memory View Type
# memory_view_data = memoryview(b'hello') 
# print(f"memory_view_data = {memory_view_data}") # memory_view_data = <memory at 0x00000205BA4C4880> (changed after each compilation)


# # Print all the data types
# print(F'Print all data types')
# print("Numeric Types:")
# print(num_integer, type(num_integer)) # 42 <class 'int'>
# print(num_float, type(num_float)) # 3.14 <class 'float'>
# print(num_complex, type(num_complex)) # (1+2j) <class 'complex'>

# print("\nSequence Types:")
# print(str_text, type(str_text)) #Hello, World! <class 'str'>
# print(list_numbers, type(list_numbers)) #[1, 2, 3] <class 'list'>
# print(tuple_coordinates, type(tuple_coordinates)) #(10, 20) <class 'tuple'>

# print("\nMapping Type:")
# print(dict_person, type(dict_person)) #{'name': 'John', 'age': 30} <class 'dict'>

# print("\nSet Types:")
# print(set_numbers, type(set_numbers)) #{1, 2, 3} <class 'set'>
# print(frozenset_numbers, type(frozenset_numbers)) #frozenset({1, 2, 3, 5}) <class 'frozenset'>

# print("\nBoolean Type:")
# print(is_active, type(is_active)) #True <class 'bool'>
# print(is_disabled, type(is_disabled)) #False <class 'bool'>
...
# print("\nRange Type:")
# print(range_data, type(range_data)) #range(0, 5) <class 'range'>

# print("\nEllipsis Type:")
# print(ellipsis_data, type(ellipsis_data)) #Ellipsis <class 'ellipsis'>

# print("\nComplex Type:")
# print(complex_number, type(complex_number)) #(2+3j) <class 'complex'>

# print("\nMemory View Type:")
# print(memory_view_data, type(memory_view_data)) #<memory at 0x0000026021654880> <class 'memoryview'>
...
# # common_elements_2 = list1 & list2 #TypeError: unsupported operand type(s) for &: 'list' and 'list'
# # print(f'common_elements_2 = {common_elements_2}')
...
# complex_num1 = 2 + 3j
# complex_num2 = 1 - 2j
# addition_result = complex_num1 + complex_num2 # (3+1j)
# multiplication_result = complex_num1 * complex_num2 #(8-1j)
...
# print(f'list_tuples_sorted = {list_tuples_sorted}') # list_tuples_sorted = [(1, 5), (2, 3), (3, 1)]
# list_tuples_sorted = sorted(list_tuples, key=lambda x: x[0])
# print(f'list_tuples_sorted = {list_tuples_sorted}') # list_tuples_sorted = [(1, 5), (2, 3), (3, 1)]
# list_tuples_sorted = sorted(list_tuples, key=lambda x: x[1])
# print(f'list_tuples_sorted = {list_tuples_sorted}') # list_tuples_sorted = [(3, 1), (2, 3), (1, 5)]

# # Using zip to merge two lists into a list of tuples
# list_a = [1, 2, 3]
# list_b = ['a', 'b', 'c']
# merged_list = list(zip(list_a, list_b)) # [(1, 'a'), (2, 'b'), (3, 'c')]
...
# print(f'dict_ages = {dict_ages}') #dict_ages = {'Bob': 32}
# dict_person = {'Alice': 25, 'Bob': 32, 'Eve': 27}
# dict_ages = {name: age for name, age in dict_person.items() if age > 30}

# # Set Types & Lambda Functions
# set_numbers = {1, 2, 3, 4, 5}
# doubled_numbers = map(lambda x: x * 2, set_numbers) # 
...
# print(f'dict_age = {dict_ages}') #dict_ages = {'Bob': 32}
...
# print(f'is_even = {is_even}') # is_even = <function <lambda> at 0x00000271E191A2A0>
# print(f'is_even = {is_even(18)}') # is_even = True
...
# print(f'is_prime = {is_prime(23)}') # True
...
# l1.sort()
# print(f'l1 = {l1}') # l1 = [2, 5, 9, 10, 10, 11, 67]

# # Sort the list in descending order
# l1.sort(reverse=True)
# print(f'l1 = {l1}') #l1 = [67, 11, 10, 10, 9, 5, 2]
...
# cumulative_sum = [numbers[0]] + [add_func(numbers[i], cumulative_sums[i-1]) for i in range(1, len(numbers))]
